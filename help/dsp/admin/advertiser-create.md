...
1. 을(를) 지정합니다. [광고주 설정](advertiser-settings.md):
   ...
   1. 에서 [!UICONTROL General] 설정:
      ...
      1. (선택 사항) DSP과 다른 Adobe Experience Cloud 제품 간의 통합을 구성하려면 광고주의 Experience Cloud을 입력합니다 [!DNL Organization ID] 에서 [!UICONTROL Adobe IMS IDs] 섹션에서 제품 통합을 구성한 다음 [!UICONTROL Integrations] 섹션을 참조하십시오.
