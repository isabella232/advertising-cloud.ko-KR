...
+ 캠페인 관리 {#campaign-management}
   ...
   + 광고 {#ads}
      ...
      + Advertising Cloud 제공 광고 {#advertising-cloud-served}
      ...
      + 대량 타사 광고 {#bulk-third-party}
         ...
         + [ [!DNL Flashtalking]으로 광고 만들기](/help/dsp/campaign-management/ads/ad-create-flashtalking.md)
   ...
   + 스프레드시트 {#qa-spreadsheet}를 사용하여 캠페인에 대한 배치 설정 수정
...
+ 최적화 {#optimization}
   + [캠페인을 최적화하는 방법 [!DNL DSP] ](/help/dsp/optimization/optimization-how-dsp-optimizes-campaigns.md)
...
+ 대상 {#audiences}
   ...
   + 세그먼트 관리 {#segments}
      ...
      + [!UICONTROL CCPA Opt-out-of-Sale] 세그먼트  {#ccpa-opt-out-of-sale-segments}
         + [[!UICONTROL CCPA Opt-out-of-Sale] 세그먼트 정보](/help/dsp/audiences/ccpa-opt-out-about.md)
...
+ 인벤토리 {#inventory}
   ...
   + [ [!DNL Roku Inventory] 사용](/help/dsp/inventory/roku-inventory.md)
   + [SSP 파트너](/help/dsp/inventory/ssp-partners.md)
   + [!DNL On Demand] 인벤토리  {#on-demand}
      + [Premium Inventory 정보 [!DNL On Demand] ](/help/dsp/inventory/on-demand-inventory-about.md)
      + 사용 가능한 [!DNL On Demand] Premium 인벤토리 게시자 {#publishers}
      ...
      + [ [!DNL On Demand] Premium 인벤토리 거래에 가입 및 액세스 요청](/help/dsp/inventory/on-demand-inventory-subscribe.md)
      + [재요청 [!DNL On Demand] Premium 재고 거래](/help/dsp/inventory/on-demand-inventory-rerequest.md)
   ...
   + 비공개 인벤토리 {#private-inventory}
      + 거래 ID {#deal-ids}
         ...
         + 수동으로 입력한 거래 ID {#manual}
            + [수동으로 [!UICONTROL Deal ID] 세부 정보 만들기](/help/dsp/inventory/deal-id-create.md)
            + [수동 [!UICONTROL Deal ID] 설정](/help/dsp/inventory/deal-id-settings.md)
      + 프로그램 방식으로 보장되는 거래 {#programmatic-guaranteed-deal}
         ...
         + [!DNL FreeWheel] 프로그램 방식의 보장 거래  {#freewheel}
            + [ [!DNL FreeWheel]에서 프로그래밍 방식 보장 거래 설정에 대한 개요](/help/dsp/inventory/freewheel-overview.md)
            + [프로그램 형식 보장 거래에 대한 광고를 [!DNL FreeWheel]에 제출합니다.](/help/dsp/inventory/freewheel-submit.md)
            + [광고 상태 확인( [!DNL FreeWheel] 프로그래밍 방식의 보장 거래)](/help/dsp/inventory/freewheel-check-status.md)
